...
<html>
	...
	<body>
		...
		?>
		<main >
		<h4 align="center">Your published articles :</h4>
		...
		echo "<table class='table table-bordered table-hover' width='100%'><thead><td>Article Code</td><td>Title</td><td>Your ID</td><td>Request Date </td><td>Publishing Date</td><td>Article Content</td><td>Article Image</td><td>Your Articale statue</td><td>Actions :</td></thead>";
		...
		echo '</table><a href="Ajouter_article.php"><button class="btn btn-success">+ Add New Article</button></a>';
		}
